...
class CreateShiftInfoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('constants.SHIFT_TIMING_TABLE'), function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('constants.SHIFT_TIMING_TABLE'));
    }
}
