...
class CreateReviseSalaryMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create(config('constants.REVISE_SALARY_MASTER_TABLE'), function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('constants.REVISE_SALARY_MASTER_TABLE'));
    }
}
