	...
	@foreach($recordDetails as $recordDetail)
		...
		@endphp
			<tr class="text-left">
                ...
                <td>{{ ( isset($recordDetail->action_date)  ? convertDateFormat($recordDetail->action_date,'d.m.Y') : '' ) }}</td>
                <td>
                ...
                <td>{{ ( isset($recordDetail->time)  ? convertDateFormat ( $recordDetail->time, 'h:i A' ) : '' ) }}</td>
            </tr>
		@endforeach
	@if(!empty($pagination))
