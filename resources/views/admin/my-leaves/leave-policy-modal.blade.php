    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body overflow-hidden">
                <div class="row ">
                    <div class="col-12">
                        <h4 class="address-title mb-3">{{ trans("messages.paid-leave") }}</h4>
                        <p>Paid leaves are the general leaves. This leave is for an employee to attend to his/her personal tasks, etc. The leave has to be applied and approved at least 2 days in advance</p>
                    </div>
                    <div class="col-12">
                        <h4 class="address-title mb-3">{{ trans("messages.leave-quota") }}</h4>
